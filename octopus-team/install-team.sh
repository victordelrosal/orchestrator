...
echo -e "    2. ${GREEN}All 5 agents spawn concurrently${RESET} in separate tmux windows"
echo -e "    3. Agents converse via .octopus/conversation.jsonl"
echo -e "    4. Agents with dependencies poll for prerequisites"
echo -e "    5. Purple Manager monitors, resolves questions, synthesizes"
echo -e "    6. Live conversation feed in your terminal"
echo ""
